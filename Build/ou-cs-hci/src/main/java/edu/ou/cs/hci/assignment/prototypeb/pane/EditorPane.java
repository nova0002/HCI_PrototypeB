...
public final class EditorPane extends AbstractPane
{
	...
	private void	updateMoviePropertiesInModel()
	{
		...
		controller.set("movie.rating", handleRating(movie.getRating()));
		controller.set("movie.runtime", movie.getRuntime());
		controller.set("movie.award.picture", movie.getPictureAward());
		controller.set("movie.award.directing", movie.getDirectingAward());
		controller.set("movie.award.cinematography", movie.getCinemaAward());
		controller.set("movie.award.acting", movie.getActingAward());
		controller.set("movie.averageReviewScore", movie.getReviewScore());
		controller.set("movie.numberOfReviews", movie.getNumberOfReviews());
		controller.set("movie.director", movie.getDirector());
		controller.set("movie.isAnimated", movie.getIsAnimated());
		controller.set("movie.isColor", movie.getIsColor());
	...
	private Integer	handleRating(String rating)
	{
		if (rating.equals("G"))
		{
			return 0;
